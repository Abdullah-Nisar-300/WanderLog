// trip_card.dart
// A custom Card containing a Stack to overlay the trip name, dates, and budget details over a cover image.
        ...
        child: SizedBox(
          ...
          child: Stack(
            children: [
              ...
              Positioned.fill(
                child: Image.network(
                  ...
                  errorBuilder: (context, error, stackTrace) {
                    // Fallback visual in case network images are blocked or offline
                    return Container(
              ...
              // // Stack used here to layer gradient over image so text is readable
              Positioned.fill(
                child: DecoratedBox(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                          'Spent: $currencySymbol${totalSpent.toStringAsFixed(0)} / $currencySymbol${trip.budget.toStringAsFixed(0)}',
                          style: const TextStyle(
                            fontSize: 11,
                            color: Colors.white70,
